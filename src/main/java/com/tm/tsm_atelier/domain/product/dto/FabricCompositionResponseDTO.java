 ...
 * {@code material} é a constante, que o cliente compara e envia de volta, e
 * {@code label} é o texto em português. Sem o rótulo, cada consumidor manteria
 * a própria tabela de tradução — e seria mais um lugar onde o vocabulário
 * derrapa.
 */
