...
public class DashboardController {
	 ...
	 *
	 * <p>
	 * {@code lowStockPage} existe porque a amostra de vinte linhas era um beco sem
	 * saída: a resposta dizia "20 de 37" e não havia como chegar aos outros
	 * dezessete. Como a lista vem ordenada do menor estoque para o maior, mexer no
	 * limiar corta pelo lado errado — os que faltam são justamente os de estoque
	 * mais alto, e não existe piso para excluir os já vistos.
	 *
	 * <p>
